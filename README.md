...
## 关键问题
本分析旨在回答以下问题
1.热门产品：收入最高的10种SKU是什么？与高利润的10种SKU是否匹配？与高库存SKU是否匹配？是否存在库存高销量低的产品？
2.客户结构：公司在哪些群体的平均收入更高？
3.定价分析：公司在护肤品、护发品和化妆品三大产品类型的价格范围？
4.运输分析：海运、空运、铁路、公路四种运输方式的运输成本、运输时间、不良率？
5.供应商分析：不同供应商的交货时间和运输成本的差别？
